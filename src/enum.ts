export const generateMockID = "fakeResponse.generateMockFromHAR";
export const filterBySchemaID = "fakeResponse.filterBySchema";
export const startServerID = "fakeResponse.startServer";
